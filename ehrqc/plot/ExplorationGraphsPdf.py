...
def plot(sourceFiles, colNamesDict, outputFile, labels):
    ...
    for key in colNamesDict.keys():
        ...
        sns.violinplot(data=plotDf, x="x", y="y", ax=ax)
        ...
        pdf.image(img, w=pdf.w * 0.8)  # Make the image full width
...
if __name__ == "__main__":
    ...
    plot(
        sourceFiles=args.source_file_list,
        colNamesDict=args.columns,
        outputFile=args.save_path[0],
        labels=args.labels,
    )
