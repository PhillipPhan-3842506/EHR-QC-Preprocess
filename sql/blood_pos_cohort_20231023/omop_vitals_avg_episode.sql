...
(
    ...
    person_id
    , visit_occurrence_id
    , avg("Peripheral oxygen saturation") AS "Peripheral oxygen saturation"
    , avg("Respiratory rate") AS "Respiratory rate"
    , avg("Temperature") AS "Temperature"
    , avg("Systolic blood pressure") AS "Systolic blood pressure"
    , avg("Diastolic blood pressure") AS "Diastolic blood pressure"
    , avg("Mean blood pressure") AS "Mean blood pressure"
